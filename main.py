...
deciston_tree_model = load_model('dt_model.pkl')
                                 
sm_model = load_model('svm_model.pkl')

knn_model = load_model('knn_model.pkl')

voting_classtfter_model = load_model('voting_clf.pkl')
...
def make_predictions(input_df, input_dict):
  ...
  with col2:
    ...
    st.plotly_chart(fig_probs, use_contatner_width=True)
...
of churning:
  ...
  Generate an email to the customer based on their information, asking them to stay if they are at risk of churning or offering them incentives so that they becone more loyal to the bank.
